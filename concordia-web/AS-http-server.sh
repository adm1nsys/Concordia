...
NO_FORMAT=$(tput sgr0)
C_RED1=$(tput setaf 1)
GITHUB_REPO_URL="https://github.com/adm1nsys/http-master"
echo "${GREEN}"
...
LATEST_VERSION_RAW=$(curl -s "https://raw.githubusercontent.com/adm1nsys/http-master/master/ASV.txt")
if [ $? -ne 0 ]; then
...
cd ~/concordia-web || { echo "Directory not found"; exit 1; }
...
1)
echo "Checking for updates..."
LATEST_VERSION=$(curl -s "https://raw.githubusercontent.com/adm1nsys/http-master/master/mac/ASV.txt")  # получаем последнюю версию
...
curl -s -o "$TMP_FILE" "https://raw.githubusercontent.com/adm1nsys/http-master/main/mac/AS-http-server.sh"
